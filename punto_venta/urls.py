...
urlpatterns = [
    ...
    re_path(r'ventas/ticket/(?P<pk>\d+)/$', views.ticket, name='ticket'),
    re_path(r'ventas/factura/(?P<pk>\d+)/$', views.factura, name='factura'),
    path('ventas/excel/', views.excel, name='excel'),
